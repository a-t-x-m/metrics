...
var caller_callsite_1 = __importDefault(require("caller-callsite"));
...
var Metrics = /** @class */ (function () {
    function Metrics(trackingID, options) {
        ...
        if (atom.inDevMode() && this.options.trackDevMode !== true) {
            developer_console_1.log(this.title + ": Tracking has not been enabled for Developer Mode, aborting");
            return;
        }
        if (atom.inSpecMode() && !this.options.trackSpecMode !== true) {
            developer_console_1.log(this.title + ": Tracking has not been enabled for Spec Mode, aborting");
            return;
        }
    ...
    Metrics.prototype.commandListener = function () {
        ...
        filteredCommands.map(function (command) {
            developer_console_1.log(_this.title + ": Adding event listener for command:", command);
    ...
    Metrics.prototype.getPackageName = function () {
        var callerPath = caller_callsite_1.default().getFileName();
