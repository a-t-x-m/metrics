...
var Metrics = /** @class */ (function () {
    function Metrics(trackingID, options) {
        ...
        if (atom.inDevMode() && this.options.trackDevMode !== true) {
            developer_console_1.log(this.title + ": Tracking has not been enable for Developer Mode, aborting");
            return;
        }
        if (atom.inSpecMode() && !this.options.trackSpecMode !== true) {
            developer_console_1.log(this.title + ": Tracking has not been enable for Spec Mode, aborting");
            return;
        }
